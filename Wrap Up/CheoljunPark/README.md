...
### 🎯 Sub-III 5일차(2024.02.02)

| 목표                                  | 진행 상태 | 상세 내용 |
| ------------------------------------- | --------- | --------- |
| OpenVidu EC2 on-premise 방식으로 실행 | ⬜        | • 진행중  |

### 🎯 Sub-III 4일차(2024.02.01)

| 목표                          | 진행 상태 | 상세 내용                                               |
| ----------------------------- | --------- | ------------------------------------------------------- |
| 프론트엔드, 백엔드 CI/CD 구축 | ✅        | • 프론트엔드는 frontend-deploy, 백엔드는 backend-deploy |

### 🎯 Sub-III 3일차(2024.01.31)

| 목표                                  | 진행 상태 | 상세 내용 |
| ------------------------------------- | --------- | --------- |
| OpenVidu EC2 on-premise 방식으로 실행 | ⬜        | • 실패    |

### 🎯 Sub-III 2일차(2024.01.30)

| 목표                             | 진행 상태 | 상세 내용 |
| -------------------------------- | --------- | --------- |
| 프론트엔드, 백엔드 EC2 수동 배포 | ✅        | • 성공    |

### 🎯 Sub-III 1일차(2024.01.29)

| 목표                             | 진행 상태 | 상세 내용 |
| -------------------------------- | --------- | --------- |
| 프론트엔드, 백엔드 EC2 수동 배포 | ⬜        | • 실패    |

### 🎯 Sub-II 9일차(2024.01.25)

| 목표                             | 진행 상태 | 상세 내용 |
| -------------------------------- | --------- | --------- |
| 행사(기억, 추억) 리스트 api 작업 | ✅        |           |

### 🎯 Sub-II 8일차(2024.01.24)
...
### 🎯 Sub-II 7일차(2024.01.23)

| 목표        | 진행 상태 | 상세 내용 |
| ----------- | --------- | --------- |
| Gerrit 구축 | ✅        |           |

### 🎯 Sub-II 6일차(2024.01.22)

| 목표                                    | 진행 상태 | 상세 내용 |
| --------------------------------------- | --------- | --------- |
| 스크럼 회의                             | ✅        |           |
| ec2 ssh 연결                            | ✅        |           |
| jdk, mysql, jenkins, nginx, docker 설치 | ✅        |           |
